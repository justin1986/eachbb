		...
		<div id="c_l">
			...
			<div id=cr>
				...
				<div class=month_c id="month_0" style="<?php if($age == 1)echo "display:inline;"; ?>">
					<div class="month" style="<?php if($mon == 1) echo "background: url(/images/info/month_bg_red.jpg) no-repeat;" ;?>" style="margin-left:53px;">1月</div>
				...
				<div class=month_c id="month_1"  style="<?php if($age == 2)echo "display:inline;"; ?>">
					<div class="month" style="<?php if($mon == 13){ echo "background: url(/images/info/month_bg_red.jpg) no-repeat;";}?>" style="margin-left:53px;">13月</div>
				...
				<div class=month_c id="month_2" style="<?php if($age == 3)echo "display:inline;"; ?>">
					<div class="month" style="<?php if($mon == 25){ echo "background: url(/images/info/month_bg_red.jpg) no-repeat;";}?>"  style="margin-left:53px;">25月</div>
