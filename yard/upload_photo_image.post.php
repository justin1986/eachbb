	...
	<body>
		<?php
			...
			$save_e = "/upload/".$save_name;
				...
				$last="insert into eachbb_member.lastest_news (resource_id,resource_type,u_id,created_at,u_name,u_avatar,form,photo,content)values('$upload_select_id','image','$id',now(),'$u_name','$u_avatar','添加了新的照片。','$save_e','添加了新的照片。')";
				$u_name=$user->name;
