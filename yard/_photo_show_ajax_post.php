<?php
	...
	$nb=$db->record_count;
	$album=$db->query("select id,name,created_at from eachbb_member.album where id=(SELECT album_id FROM eachbb_member.photo where id=$id);");
...
<div id="title_container">
	...
	<table width="770" height="12" border="0" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td width="92" align="center" style="border-left:1px dashed #000000;"><a href="#">返回该专辑</a></td>
