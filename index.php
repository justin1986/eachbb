						...
						<div id="student_value">
							...
							<?php
								...
								<div class = "student_pg"<?php $pos="top_tab_1_$i";show_page_pos($pos,'link');?>>
									...
									<a href="<?php echo $pos_items[$pos]->href;?>"  title="<?php echo $pos_items[$pos]->title;?>" target ='_blank'><?php echo mb_strlen($pos_items[$pos]->title,"utf-8")>14 ? mb_substr($pos_items[$pos]->title,0,14,"utf-8")."...":$pos_items[$pos]->title;?></a>
								</div>
								<?php if($i != 3){?>
					...
					<div class="desc" id="desc_<?php echo $j;?>" <?php if($j>0) echo " style='display:none;'"?>>
						...
						<div class="dict_c"<?php $pos="right_tab_{$j}_{$i}";show_page_pos($pos,'link');?>>
							...
							<div class="dict_value" style='margin-top:3px;'>
								<a href="$pos_items[$pos]->href" title="<?php echo $pos_items[$pos]->title;?>" target="_blank"><?php echo mb_strlen($pos_items[$pos]->title,"utf-8") > 13 ? mb_substr($pos_items[$pos]->title,0,13,"utf-8"):$pos_items[$pos]->title;?></a>
						</div>
						<?php } ?>
					</div>
					<?php }?>
				...
				<div id="mother_l">
					...
					<div id="m_l_c">
						...
						<div id="m_l_b"<?php $pos="assistant_head";show_page_pos($pos,'link_t_d')?>>
							<div id="m_c_title" title="<?php echo $pos_items[$pos]->title;?>"><?php echo mb_strlen($pos_items[$pos]->title,"utf-8")>8? mb_substr($pos_items[$pos]->title,0,8,"utf-8")."...":$pos_items[$pos]->title;?></div>
							<div id="m_c_content"><?php echo $pos_items[$pos]->description ? mb_substr($pos_items[$pos]->description, 0 ,45, "UTF-8")."...":'' ;?></div>
						...
						<div id="m_l_c_r">
							<?php 
								...
								for($i=1;$i<8;$i++){ 
									...
									?>
							<div class="mlc">
								<a  href="/assistant/assistant.php?id=<?php echo $list[$i]->id;?>" target="_blank">[<?php echo $type[0]->name;?>]<?php echo mb_strlen($list[$i]->title,"utf-8")>8 ? mb_substr($list[$i]->title,0,8,"utf-8")."...":$list[$i]->title;?></a>
							</div>
							<?php } ?>
						</div>
					</div>
