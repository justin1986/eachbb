							...
							<div class="son_c_z">
								...
								<div class="son_c_z_r">
									<a  href="/assistant/assistant.php?id=<?php echo $list[$k]->id;?>" target="_blank" title="<?php echo $list[$k]->title;?>">
										...
										?>
										<?php echo ( $number_name+$number_title >17 ? "<font style='color:#01D3F1; font-size:12px;'>[".$type[0]->name."]</font>".mb_substr($list[$k]->title,0,16-$number_name,"utf-8")."<font style='font-size:10px;'>...</font>":"<font style='color:#01D3F1; font-size:12px;'>[".$type[0]->name."]</font>".$list[$k]->title);?>
									</a>
								</div>
							</div>
							<?php } ?>
