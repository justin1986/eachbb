						...
						<div id="m_l_c_r">
							<?php 
								...
								for($i=1;$i<8;$i++){ 
									...
									?>
							<div class="mlc">
								<a  href="/assistant/assistant.php?id=<?php echo $list[$i]->id;?>" target="_blank"  title="<?php echo $list[$i]->title;?>"><?php echo mb_strlen("[".$type[0]->name."]".$list[$i]->title,"utf-8")>19 ? mb_substr("[".$type[0]->name."]".$list[$i]->title,0,19,"utf-8")."...":"[".$type[0]->name."]".$list[$i]->title;?></a>
							</div>
							<?php } ?>
						</div>
					</div>
					...
					<div id="m_r_c">
						...
						<div class="son_content">
							...
							<div class="son_c_z"<?php $pos="right_news_list_$j";show_page_pos($pos,'link')?>>
								...
								<div class="son_c_z_r">
									<a href="<?php echo $pos_items[$pos]->href;?>" target='_blank' title="<?php echo $pos_items[$pos]->title;?>"><?php echo mb_strlen($pos_items[$pos]->title,"UTF-8")>16 ? mb_substr($pos_items[$pos]->title, 0 ,16, "UTF-8")."...":$pos_items[$pos]->title ;?>
								</div>
							</div>
							<?php }?>
						</div>
