						...
						<div id="student_value">
							...
							<?php
								...
								<div class = "student_pg"<?php $pos="top_tab_1_$i";show_page_pos($pos,'link');?>>
									...
									<a href="<?php echo $pos_items[$pos]->href;?>"  title="<?php echo $pos_items[$pos]->title;?>" target ='_blank'><?php echo mb_strlen($pos_items[$pos]->title,"utf-8")>16 ? mb_substr($pos_items[$pos]->title,0,15,"utf-8")."...":$pos_items[$pos]->title;?></a>
								</div>
								<?php if($i != 3){?>
