...
<head>
<title>小院子</title>
<link href="./css/yard.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="ibody">
	<div id="y_top">
				...
				<div id="menu_center">
					<div id="menu_ct">
						<div id="menu_ctt">
							...
							<div class="me_h"></div>
							<a href="#">
							<div class="me_b">亲子社区</div>
							</a>
							<div class="me_h"></div>
							<a href="#">
							<div class="me_b">资讯板块</div>
							</a>
							<div class="me_h"></div>
							<a href="#">
							...
							<div class="mn_hr"><a href="#" style=" color:#000;">帮助</a></div>
						</div>
					</div>
				</div>
		...
		<div id="c_c">
			...
			<div id="cc_c">
					...
					<div id="cc_ps"> <a href="#">
						...
						<div id="ccps_c">
							<div id="ccpsc_l">
								...
								<a href="#">
								<div id="ccpsc_word">发分享</div>
								</a> </div>
							<div id="ccpsc_la">
								<div id="ccpsc_imga"></div>
								<a href="#">
								<div id="ccpsc_worda">传照片</div>
								</a> </div>
							<div id="ccpsc_lb">
								<div id="ccpsc_imgb"></div>
								<a href="#">
								<div id="ccpsc_wordb">发股票</div>
								</a> </div>
							<div id="c_moblie">
								<div id="c_moblie_i"></div>
								<a href="#">
								<div id="c_moblie_w">手机发布</div>
								</a> </div>
						</div>
						<div id="c_ch">
							<div id="m_w"></div>
				...
				<div id="r_pho">
					...
					<div id="r_geng"> <a href="#">
						<div id="r_ge_a">
							<div id="r_gi_a"></div>
							<div id="r_gw_a">更换头像</div>
						</div>
						</a> <a href="#">
						<div id="r_ge_b">
							<div id="r_gi_b"></div>
							<div id="r_gw_b">修改档案</div>
						</div>
						</a> </div>
					<div id="r_ge_ge">
						<div id="r_ge_hr"></div>
