		...
		<div class=fc_c>
			<div class="fc_c_t">
				...
				<?php	
				 ...
				 for($i=6;$i<8;$i++){ 
				 	if($i==6){
				 		$sql="SELECT id,show_image FROM eb_category where parent_id=12 limit 2";	
				 	}else{
				 		$sql="SELECT id,show_image FROM eb_category where parent_id=12 limit 2,4";
				 	}
				 	$img_assistant = $db->query($sql);
				 	?>
				<div class=content>
				<div class="fcl_l">
					<div class="fci_a"<?php #$pos = "list_image_{$i}_a";show_page_pos($pos,'link_i')?>><a href="/assistant/list.php?category_id=<?php echo $img_assistant[0]->id;?>"><img style="border:0px solid red;" src="<?php echo $img_assistant[0]->show_image;#$pos_items[$pos]->image1 ? $pos_items[$pos]->image1 :'/images/helper/peo.jpg';?>"></a></div>
					<div class="fci_b"<?php #$pos = "list_image_{$i}_b";show_page_pos($pos,'link_i')?>><a href="/assistant/list.php?category_id=<?php echo $img_assistant[1]->id;?>"><img style="border:0px solid red;" src="<?php echo $img_assistant[1]->show_image;#$pos_items[$pos]->image1 ? $pos_items[$pos]->image1 :'/images/helper/peo.jpg';?>"></a></div>
				</div>
				<div class="fcl_r">
				<?php 
