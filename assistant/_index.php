				...
				<div class="list_item">
					...
					<div class="item">
						...
						if(mb_strlen($assistant->name.$assistant->title,"utf-8") > 19){?>
							[<a href="list.php?category_id=<?php echo $assistant->category_id?>" class="a_category_list"><?php echo $assistant->name;?></a>] <a href="assistant.php?id=<?php echo $assistant->id;?>" title="<?php echo $assistant->title?>" target="_blank" ><?php echo mb_substr($assistant->title,0,15-mb_strlen($assistant->name,"utf-8"),"utf-8")."...";?></a>
							<?php
