		...
		<div class="list_box" id="list_box_<?php echo $i + 1;?>">
			...
			<div class="list_item_box">
				...
				<div class="list_item">
					<div class="dot"></div>
					<div class="item">
						<?php if(mb_strlen($assistant->name.$assistant->title) > 20){?>
							[<a href="list.php?category_id=<?php echo $assistant->category_id?>" class="a_category_list"><?php echo $assistant->name;?></a>] <a href="assistant.php?id=<?php echo $assistant->id;?>" title="<?php echo $assistant->title?>" target="_blank" ><?php echo mb_substr($assistant->title,0,19,"utf-8")."..."?></a>
							<?php
