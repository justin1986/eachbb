...
<div class="result_banner">
	...
	<div class="result_pg_content">
		...
		<div class="result_container2" style="<?php if($i == 0) echo "margin-top:5px;"; ?>">
			...
			<div class="result_value"><?php echo mb_substr(strip_tags($assistant->content),0,56,'utf-8');?>……<a href="/assistant/assistant.php?id=<?php echo $assistant->id;?>" target="_blank">[查看全文]</a></div>
		</div>
		<?php }?>
