...
<div id="ibody">
	...
	<div id="iframe_container">
		...
		<iframe id="iframe" name="iframe" src="/assistant/list.php?page_type=<?php echo $page_type;?>&age=<?php echo $_GET['age'];?>&category_id=<?php echo $category_id;?>" width="745px" height="2700px" frameborder="0" scrolling="no" ></iframe>
		<?php }else {
			?>
