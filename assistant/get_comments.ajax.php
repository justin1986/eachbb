<?php 
	...
	$db=get_db();
	$sql = "SELECT n.id,n.resource_id,n.nick_name,n.comment,n.created_at,e.comment_id,e.up,e.down FROM eb_comment n left join eb_comment_dig e on n.id=e.comment_id where resource_type='assistant' and resource_id ={$id} order by created_at desc";
...
<div id="critique">
	...
	<?php } ?>
	<div class="fun"><?php paginate("/assistant/get_comments.ajax.php",'res','comment_page'); ?></div>
</div>
