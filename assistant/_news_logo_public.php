...
?>
<div id="class">
		<div id="br_img" class="ad_banner"></div>
		<div class="cla_t"></div>
		<div class="cla_c">
...
//				$list=$db->query("SELECT id,name,url FROM eb_images  where category_id in (".$news_id.") and is_adopt=1 order by create_time desc,click_count desc limit 3;");
			...
			<div class="ad_banner" id="wenzhan_right" style="width:289px; height:195px; margin-top:10px; border:0px solid red; float: right; display:inline;" ></a>
		</div>
	</div>
	<div id="tag">
			<div id="tag_l"></div>
