	...
	<div id="individual">
		...
		<div id="indiv_container">
			<div id="indiv">
				...
				<div id="indiv_menu">
					<div id="indiv_name">夜晚不<img src="/images/assistant_list/pg_p.jpg"></div>
					<div class="indiv_value"><font>来自：</font>黑龙江</div>
					<div class="indiv_value"><font>性别：</font>女</div>
					<div class="indiv_value"><font>年龄：</font>1岁</div>
					<div class="indiv_value" style="color:#37B0AD;"><font>宝宝：</font>忍忍</div>
					<div class="indiv_value" style="color:#37B0AD;"><font>年龄：</font>8个月</div>
				</div>
			</div>
