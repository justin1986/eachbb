				...
				<div id="fbody">
															...
															<div id="menu_center">
																			<div id="menu_ct">
																						<div id="menu_ctt">
																									...
																									<div class="me_h"></div>
																									<a href="#"><div class="me_b" style="background:url(images/bbs/mo_pg.jpg) no-repeat;"><font class="son">早教</font><font class="bbs">课程</font></div></a><div class="me_h"></div>
							...
							<div id="content">
										<div id="c_l">
																...
																<a href="#"><div id="l_test"></div></a>
																<a href="#"><div id="l_look"></div></a>
																<div class="hlc_t"></div>
													<div class="hlc_b">
																<div class="hlcb_pg">
										...
										<div id="c_r">
														...
														<div id="crcb_t">
															<?php for($i=0;$i<6;$i++){?>
																<a href="#"  style="<?php if($i==0){ echo 'color:#ffffff;';} ?>"><div class="cr_a" style="<?php if($i==0){ echo 'margin-left:0px;';} if($i==5){echo 'margin-left:16px;';}?>">我的宝宝</div></a>
																<?php 
																}
																?>
														</div>
																			...
																			<div id="cric_pg">
																				<div id="pric_l"></div>
																						...
																						<div id="cric_c">
																									...
																									<div class="cricc_a">
																												<div>
																															<img src="images/class/c_pg_a.jpg">
																												</div>
																									</div>
																								</a>
																									<?php 
