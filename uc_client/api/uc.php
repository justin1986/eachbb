...
define('DISCUZ_ROOT', dirname(__FILE__) .'/../../bbs/');
require_once DISCUZ_ROOT.'../config/config.php';
//uc_client defination
define('UC_APPID', '2');
...
class uc_note {
	...
	function synlogin($get, $post) {
		...
		include_once DISCUZ_ROOT."../frame.php";
		include_once DISCUZ_ROOT."../inc/user.class.php";
		write_log('called synlogin');
		User::login_by_uid($uid);
	}
	...
	function updatepw($get, $post) {
		...
		$user = User::find(array('condition'=>"name='$username'"));
		if($user){
			$user[0]->reset_password($password,'',1,false);
		}
		return API_RETURN_SUCCEED;
	}
