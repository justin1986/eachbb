...
<div id="ibody">
	...
	<div id="haha">
			<?php 
			$array = $db->query("SELECT e.id,e.problem_id,e.score,e.created_at,s.name FROM eachbb.eb_test_record e left join eachbb.eb_problem as s on e.problem_id=s.id where e.problem_id={$id} order by created_at desc;");
			if(!$array){
