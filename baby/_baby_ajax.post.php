<?php 
	...
	$array = $db->query("select a.problem_id,b.name,a.created_at,b.problem_type from eb_test_record as a  left join eb_problem b on b.id=a.problem_id where a.user_id={$user->id} group by user_id,problem_id order by a.created_at desc limit 20;");
