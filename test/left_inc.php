...
<div id="c_l">
	...
	<div id="pic_r">
		...
		<div class="ppg">
			<div class="pic_pg">
				<div class="pic_img"><a href="/yard/index.php?id=<?php echo $friend->f_id;?>"><img  style="border:0px solid red;" src="<?php echo $friend->f_avatar; ?>"></a></div>
			</div>
			<div class="ppg_w"><a href="/yard/index.php?id=<?php echo $friend->f_id;?>" style="font-size:12px; color:#000000; text-decoration: none;"><?php echo $friend->f_name; ?></a></div>
		</div>
		<?php }
		if(!$list){
	...
	<?php }?>
	<div id="pg_a" class="ad_banner"></div>
</div>
<style>
