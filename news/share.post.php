...
//	}
	...
	for($i=0;$i<$len;$i++){
		...
		$news_share->save();
		$content = addslashes($_POST['name'][$i]."，你好：<br/><br/>　　您的好友".$user->name."想与您分享网趣宝贝的文章《".$news->title."》，您可以点击以下连接阅读<br/><br/>　　<a href='http://www.eachbaby.com/news/news.php?id=".$news_id."'>http://www.eachbaby.com/news/news.php?id=".$news_id."</a><br/>　　如果点击以上链接不起作用，请将此网址复制并粘贴到新的浏览器窗口中。");
		$title = $news->title;
		send_mail('mail.eachbaby.com','administrator@eachbaby.com','123456','administrator@eachbaby.com',htmlspecialchars($_POST['mail'][$i]),'网趣宝贝(eachbaby.com)密码找回',$content);
