...
=======
					<div class="pic_img"<?php $pos="assistan_pg_l_$i";show_page_pos($pos,'link_i');?> id="img_tab_<?php echo $i;?>"  <?php if($i == 1){ ?> style="display:block;"<?php }else{?>style="display:none;"<?php }?>>
>>>>>>> e7c2a6d1856681996a069ed3b3a74f9a4b503131
