				...
				<div id="bf_z">
					<div id="bf_zz">
						...
						<div id="bf_c">
							...
							<div id="bfc_c"><a href="<?php echo $pos_items[$pos]->href?>" target="_blank"><?php echo mb_strlen($pos_items[$pos]->description,"utf-8") > 130 ? mb_substr($pos_items[$pos]->description,0,130,'utf-8')."<a href='' class='beijiu'>...[查看全文]</a>" : $pos_items[$pos]->description ;?></a></div>
						</div>
					</div>
				</div>
				<div id="bf_b"></div>
