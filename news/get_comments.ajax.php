<?php 
	...
	$db=get_db();
	$sql = "SELECT n.id,n.resource_id,n.nick_name,n.comment,n.created_at,e.comment_id,e.up,e.down FROM eb_comment n left join eb_comment_dig e on n.id=e.comment_id where resource_type='news' and resource_id ={$id} order by created_at desc";
