		...
		<div class="login_result_value">
			<?php if($list[0]->name){?>
				<a href="/test/test_result.php?test_id=<?php echo $list[0]->problem_id;?>" target="_blank">
					您最近完成<font style="color:red;"><?php echo $list[0]->name;?></font><?php echo text($list[0]->problem_type);?>
				</a>
			<?php }else{?>
...
.login_reusult_title{width:240px; height:20px; padding-left:20px; font-weight:bold; padding-top:4px; font-size:16px; color:#333333; background:url(/images/index/login_3.jpg) no-repeat 0 7px; float:left; display:inline;}
